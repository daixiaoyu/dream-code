 ...
 *
 *              Evaluates a boolean function for each data item of the RDD and puts the items
 *              for which the function returned true into the resulting RDD.
 **/
