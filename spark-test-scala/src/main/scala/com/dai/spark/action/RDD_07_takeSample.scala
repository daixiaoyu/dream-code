 ...
 * @Description: Behaves different from sample in the following respects:
 *   1、It will return an exact number of samples (Hint: 2nd parameter)
 *   2、It returns an Array instead of RDD.
 *   3、It internally randomizes the order of the items returned.
 **/
